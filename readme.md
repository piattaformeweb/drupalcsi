...
1. Scaricare l&#39;archivio compresso site.zip
2. Scompattarlo nella cartella di destinazione
3. Scompattare e caricare lo schema site.sql.zip sul DB
4. Modificare le impostazioni relative al DB nel file /sites/default/settings.php
5.
5.Loggarsi sul sistema come _admin/P@ssw0rd!_ e modificare le impostazioni del filesystem in /admin/config/media/file-system in particolare configurando la cartella dei file pubblici 1, quella dei file privati e quella temporanea.
6. Consultare la pagina /admin/reports/status per eventuali anomalie
...
#
 La cartella /sites/default/files (e sottocartelle) deve essere scrivibile da parte del webserver.